...
var map = {
	...
	"../pages/createHome/createHome.module": [
		333,
		0
	],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WhoIsWhatProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_add_operator_toPromise__ = __webpack_require__(182);
...
var WhoIsWhatProvider = (function () {
    function WhoIsWhatProvider(storage) {
        this.storage = storage;
    }
    WhoIsWhatProvider_1 = WhoIsWhatProvider;
    WhoIsWhatProvider.prototype.createWohnung = function (wohnung) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.storage.get(WhoIsWhatProvider_1.storageKey)
                .then(function (wohnungen) {
                if (!wohnungen) {
                    wohnungen = new Array();
                }
                wohnungen.push(wohnung);
                _this.storage.set(WhoIsWhatProvider_1.storageKey, wohnungen)
                    .then(function () {
                    resolve(wohnung);
                })
                    .catch(reject);
    ...
    WhoIsWhatProvider.prototype.getWohnungen = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.storage.get(WhoIsWhatProvider_1.storageKey)
                .then(function (wohnungen) { return resolve(wohnungen ? wohnungen : new Array()); })
                .catch(reject);
        });
    };
    WhoIsWhatProvider.storageKey = 'storage';
    WhoIsWhatProvider = WhoIsWhatProvider_1 = __decorate([
    ...
    return WhoIsWhatProvider;
    var WhoIsWhatProvider_1, _a;
}());

//# sourceMappingURL=whoIsWhat.provider.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__providers_whoIsWhat_provider__ = __webpack_require__(226);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_9_ionic_angular__["d" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_12__app_component__["a" /* MyApp */], {}, {
                    links: [
                        ...
                        { loadChildren: '../pages/createHome/createHome.module#CreateHomePageModule', name: 'CreateHomePage', segment: 'createHome', priority: 'low', defaultHistory: [] },
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_13__providers_whoIsWhat_provider__["a" /* WhoIsWhatProvider */],
